...
func (c *consentServer) claimData(w http.ResponseWriter, req *http.Request) {
	...
	case "pr_card_issuer_jwtsd":
		claims = &map[string]interface{}{
			"doc_number":  "999-999-999",
			"given_name":  "John",
			"family_name": "Doe",
			"gender":      "Male",
	...
	case "vaccination_certificate_issuer":
		claims = &map[string]interface{}{
			"givenName":                    "John",
			"familyName":                   "Doe",
			"birthDate":                    "1958-07-17",
			...
			"disease":                      "COVID-19",
			"atcCode":                      "J07BX03",
			"countryOfVaccination":         "Canada",
			"dateOfVaccination":            "2021-01-03",
	...
	_ = json.NewEncoder(w).Encode(claims) //nolint:errcheck
}
