...
replace github.com/hyperledger/aries-framework-go-ext/component/vdr/orb => github.com/hyperledger/aries-framework-go-ext/component/vdr/orb v0.0.0-20210517231016-de60084e8513
