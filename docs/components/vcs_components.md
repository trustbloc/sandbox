...
| TrustBloc SignIn (Hub-Auth) | [Source](https://github.com/trustbloc/hub-auth)                            | [k8s](https://github.com/trustbloc/k8s/tree/v0.1.8/hub-auth)   |
...
| Component           | Source URL                                          | k8s Configuration                                                                         |
|---------------------|-----------------------------------------------------|-------------------------------------------------------------------------------------------|
| Issuer VC Service   | [Source](https://github.com/trustbloc/edge-service) | [k8s](https://github.com/trustbloc/k8s/tree/v0.1.8/vcs) |
| Verifier VC Service | [Source](https://github.com/trustbloc/edge-service) | [k8s](https://github.com/trustbloc/k8s/tree/v0.1.8/vcs) |
