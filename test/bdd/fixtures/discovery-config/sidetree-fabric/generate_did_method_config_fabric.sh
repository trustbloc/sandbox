...
--config-file ./fixtures/discovery-config/sidetree-fabric/config-data/testnet.trustbloc.local.json --output-directory ./fixtures/discovery-config/sidetree-fabric/config
