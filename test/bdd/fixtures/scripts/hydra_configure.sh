...
hydra clients create \
    ...
    --scope StudentCard,TravelCard,PermanentResidentCard,CertifiedMillTestReport,CrudeProductCredential,UniversityDegreeCredential,CreditCardStatement,DrivingLicense \
    --skip-tls-verify \
