...
hydra clients create \
    ...
    --scope StudentCard,TravelCard,PermanentResidentCard,VaccinationCertificate,CertifiedMillTestReport,CrudeProductCredential,UniversityDegreeCredential,CreditCardStatement,mDL,CreditScore,BookingReferenceCredential \
    --skip-tls-verify \
