...
callbackURL=https://issuer.trustbloc.local/oauth2/callback
...
echo "Starting issuer.example.com..."
issuer-rest start --oidc-clientid $clientID --oidc-clientsecret $clientSecret
